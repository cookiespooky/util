...
/* ПРАВКА ПРОЕКТА (2026-08-27), без неё файл не запускается на PHP 8.
   В оригинале 2014 года смещения в строках берутся фигурными скобками
   ($str{0}) — этот синтаксис удалён в PHP 8.0, а на хостинге PHP 8.2.
   Заменено на квадратные скобки в четырёх местах, поведение то же.
   При обновлении ридера с sypexgeo.net правку нужно повторить. */
